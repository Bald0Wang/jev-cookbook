...
md("### 4.3 实测发现：中文「你是机器人吗」语义更确定\n\n"
   ...
   "模型反而更愿意把它当作普通疑问。"
   "这是 Level 3（原语）实测校准的典型例子：**先探针、再定稿**，否则你以为「显然求真人」但模型不一定这么认为。")
...
# ============================================================ 写入
nb["cells"] = cells
nbf.write(nb, "primitives_experiments.ipynb")
print(f"✅ 已生成 primitives_experiments.ipynb，共 {len(cells)} 个单元格")