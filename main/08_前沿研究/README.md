...
![16 轮中文对话按问题类型的四路评分对比](jev_mem/figures/jev-mem-2026-09-25/short-dialogue.svg)
...
![48 至 384 轮对话中的质量、输入 token 与查询延迟变化](jev_mem/figures/jev-mem-2026-09-25/scaling.svg)
...
![LoCoMo 样本 0 的全上下文与 Jev-Mem 质量、token 和延迟对比](jev_mem/figures/jev-mem-2026-09-25/locomo-sample-0.svg)
...
图表数据快照、生成脚本与逐项实验口径保存在 [Jev-Mem 图表目录](jev_mem/figures/jev-mem-2026-09-25/) 和 [Jev-Mem 研究笔记](jev_mem/README.md)。
